...
export const fetchRecipesByQuery = createAsyncThunk(
  ...
  async function ({ searchQuery, resultsAlreadyFetched = 0 }) {
    const url = `${API_URL}complexSearch?apiKey=${API_KEYS}&diet=${dietType}&addRecipeInformation=true&query=${searchQuery}&number=${numOfResults}&offset=${resultsAlreadyFetched}`;
